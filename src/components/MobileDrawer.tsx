...
export default function MobileDrawer({isOpen, toggleDrawerOpen}: DrawerProps) {
  ...
  return (
    <div className={`bg-gray-100 text-main-purple fixed top-0 right-0 flex flex-col justify-between py-12 items-center z-10 h-full w-full transition-transform duration-300 transform ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
