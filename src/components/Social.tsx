...
export default function Social() {
  return (
    <ul className='h-8 flex flex-row mx-auto gap-2 lg:gap-6'>
        <li><a href="https://www.linkedin.com/in/danielle-lindblom/" title='LinkedIn'><img src={linkedinIcon.src} className='w-8 hover:shadow-[0_0_5px_5px_#ffbd59] rounded-full transition duration-300 ease-in-out' alt=''/></a></li>
        <li><a href="https://github.com/Danielle254" title='GitHub'><img src={githubIcon.src} className='w-8 hover:shadow-[0_0_5px_5px_#ffbd59] rounded-full transition duration-300 ease-in-out' alt=''/></a></li>
