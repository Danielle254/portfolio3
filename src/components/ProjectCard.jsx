...
export default function ProjectCard() {
  return (
    <div className='bg-light-purple bg-opacity-10 flex flex-col gap-4 rounded shadow text-light-purple items-center p-4'>
      ...
      />      
      <ul className='flex flex-row wrap text-lg list-[circle] gap-8'>
        <li>React.js</li>
        <li>JavaScript</li>
        <li>Tailwind CSS</li>
