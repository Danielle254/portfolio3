...
export default function Connect() {
  return (
    ...
    >
      ...
      >
        <li className="text-lg hover:shadow-[0_0_10px_5px_#ffbd59] hover:rounded px-2 py-1 transition duration-300 ease-in-out">
          <a
            href="https://www.linkedin.com/in/danielle-lindblom/"
            className="flex flex-row gap-4 md:gap-2 items-center"
            target="_blank"
          >
            <img src={linkedinIcon.src} className="w-6 h-6" alt="" />
            LinkedIn
            <svg
        ...
        <li className="text-lg hover:shadow-[0_0_10px_5px_#ffbd59] hover:rounded px-2 py-1 transition duration-300 ease-in-out">
          <a
            ...
            target="_blank"
          >
            <img src={githubIcon.src} className="w-6 h-6" alt="" />
            GitHub
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
        ...
        "
          >
            <img src={emailIcon.src} className="w-6 h-6" alt="" />
            Email
          </a>
        </li>
      </motion.ul>
      ...
      >
        ...
        <p className="text-lg mt-2 mb-6">
          Currently residing in Missoula, Montana and open to remote work.
        </p>
        <CustomLink
