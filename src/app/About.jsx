  ...
  return (
    <div className='h-full md:min-h-screen max-w-4xl mx-auto py-8 px-2' id='about-section'>
      ...
      <div className='relative max-w-2xl mx-auto h-0 pb-[56%] lg:pb-[40%] border border-main-pink rounded'>
          <iframe className='absolute w-full h-full left-0 top-0' src="https://www.loom.com/embed/7780d925a77e48848bc75caff6d317c3?sid=fc473fda-2fc0-4b7e-b0ce-ba8106adae53?hideEmbedTopBar=true&hide_title=true&hide_owner=true"  webkitallowfullscreen={'true'} mozallowfullscreen={'true'} allowFullScreen title='Danielle Lindblom video introduction' ></iframe>
      </div>
      <p className='text-md md:text-lg mt-8'>I love working with <span className='text-accent-orange font-bold'>React, TypeScript, and Next.js.</span></p>
